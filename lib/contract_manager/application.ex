defmodule ContractManager.Application do
  use Application
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: ContractManager.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    ContractManagerWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
